const protheusMapping = {
  dre: {
    ...
    "CUSTOS": {
      ...
      "Outros Custos e Serviços": ["4.1.1.1.07.00002", "4.1.1.1.07.00001", "4.1.1.1.07.00009", "4.1.1.1.07.00003", "4.1.1.1.07.00004", "4.1.1.1.07.00008", "4.1.1.1.07.00010", "4.1.1.2.07.00002", "4.1.1.2.07.00001"]
    },
    "DESPESAS COM VENDAS": {
    ...
    "DESPESAS ADMINISTRATIVAS": {
      ...
      "Outras Desp.Administrativas": ["4.2.1.2.90"]
    },
    ...
    "OUTRAS RECEITAS E DESPESAS": {
      ...
      "Outras Receitas Operacionais": ["4.9.1.2"]
    },
    "PROVISÃO IRPJ": {
      "Provisão IRPJ": ["7"]
    },
  ...
  passivo: {
    ...
    "PATRIMONIO LIQUIDO": {
      ...
      "Lucro do Exercício": ["2.9.9.1.01.00900"],
 ...
 */
const applyMapping = (dbData, groupMapping = {}, multiplier = 1, valueField = 'valorMensal') => {
  const result = {};
...
console.log(JSON.stringify(protheusMapping.passivo));